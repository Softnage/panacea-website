        ...
        if (winT + winH > webdesignT) {
            jQuery('.single-circle-progressber').each(function () {
                ...
                $("#Quick-designprogressbar").circleProgress({
                    ...
                    .on('circle-animation-progress', function (event, progress) {
                        $(this).find('.progressbar-percentage').html(Math.round(98 * progress) + '<i>%</i>');
...
document.getElementById("sendButton").addEventListener("click", function() {
    ...
    var whatsappMessage = encodeURIComponent("Hello, my name is "+name+"\n"+"\n" +"Subject: "+ subject + "\n" +"\n" +"Message: "+ message);
  
    // Replace the phone number with the recipient's number
    var phoneNumber = "+233572423472";
