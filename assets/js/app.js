document.addEventListener('DOMContentLoaded', () => {
    if (document.querySelector('.whiskey-cards')) {
        ...
        let autoNavigationTimer = setInterval(navigateToNextItem, autoNavigationInterval);
        ...
        slider.addEventListener('mouseout', () => {
            autoNavigationTimer = setInterval(navigateToNextItem, autoNavigationInterval);
        });
    }
});
